...
app.post('/generar-link', async (req, res) => {
    try {
        ...
        const payload = {
            nombreProducto: 'Compra desde Flutter', // ✅ CAMPO CORRECTO
            descripcionProducto: 'Pago personalizado por app', // ✅ CAMPO CORRECTO
            monto: montoCents,
            moneda: 'USD',
            cantidad: 1,
            editableMonto: false,
            editableCantidad: false,
            identificadorUnico: referencia, // ✅ YA ESTÁ CORRECTO
            datosCliente: {
