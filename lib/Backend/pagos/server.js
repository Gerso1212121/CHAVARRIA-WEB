...
app.post('/webhook/wompi', async (req, res) => {
    ...
    let referencia = req.body?.data?.referencia || req.body?.data?.transaccion?.referencia;
    ...
    const htmlContent = `...`; // mismo HTML PRO que ya tenías aquí
...
async function procesarPedidoPorReferencia(referencia) {
    ...
    console.log('📝 Detalles insertados:', detalleList);
