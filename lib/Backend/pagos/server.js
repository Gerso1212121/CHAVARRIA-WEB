...
app.post('/api/wompi/enlace', async (req, res) => {
    ...
    try {
        const { referencia, montoCents, nombreProducto, cantidad } = req.body;
        ...
        const payload = {
            ...
            configuracion: {
                ...
                cantidadPorDefecto: cantidad, // Si quieres que la cantidad aparezca por defecto
                esCantidadEditable: false, // Opcional
                urlWebhook: process.env.WEBHOOK_URL // Asegúrate de tener esto en tu .env
                // emailsNotificacion: "tu@email.com" // Puedes poner esto también si prefieres email
            }
        };
