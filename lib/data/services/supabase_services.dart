...
class SupabaseService {
  ...
  Future<AuthResponse?> signInWithEmail({
    ...
    try {
      ...
      // Si el error es por credenciales inválidas, retornamos null
      if (e.statusCode == '400' || e.statusCode == '401') {
        return null; //esto verifica los datos ingresados incorrectamente, esto se realiza de esta manera para que a la hora de intentar iniciar no se tome como conexion perdida
      }
      // Otros errores los lanzamos normalmente
